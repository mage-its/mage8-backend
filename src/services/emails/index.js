                                        ...
                                        <tr>
                                            <td align="left" style="padding:50px 50px 50px 50px">
                                                <p
                                                    ...
                                                    <strong>Halloo!</strong></p>
                                                <p
                                                    style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px ">
                                                    Terima kasih telah bersedia untuk mendaftar MAGE 8. Pertama, anda
                                                    perlu untuk mengonfirmasi akun anda. Cukup dengan menekan tombol
                                                    berikut. <br />
                                                    <br />
                                                </p>
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    style="Margin:0 auto;">
                                                                    <tr>
                                                                        <td width="250" height="60" align="center"
                                                                            bgcolor="#00a897"
                                                                            ...
                                                                            <a href="{{link}}"
                                                                                ...
                                                                                class="button_link">Verify Email</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                ...
                                                <p
                                                    style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px ">
                                                    <br />
                                                    Jika tombol tersebut tidak berfungsi, buka link di bawah ini:
                                                    {{link}}
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        ...
                                        <tr>
                                            <td class="two-column"
                                                        ...
                                                        <tr>
                                                            <td width="39%" align="right"
                                                                ...
                                                                <a href="#" target="_blank"><img
                                                                        src="https://firebasestorage.googleapis.com/v0/b/mage8-657e0.appspot.com/o/resources%2Fimages%2Flogos.svg?alt=media&token=b657f574-e38e-40e2-8e31-6b0cf9551147"
                                                ...
                                                <div class="column"
                                                    style="width:100%;max-width:248px;display:inline-block;vertical-align:top;">
                                                    <table width="100%" style="border-spacing:0">
                                                        <tr>
                                                            <td class="inner"
                                                                            ...
                                                                            <table width="150" border="0"
                                                                                ...
                                                                                <tr>
                                                                                    <td width="33" align="center"><a
                                                                                            href="https://web.facebook.com/mageits?_rdc=1&_rdr"
                                                                                            target="_blank"><img
                                                                                                src="https://firebasestorage.googleapis.com/v0/b/mage8-657e0.appspot.com/o/resources%2Fimages%2Ffb.jpg?alt=media&token=782a4610-dd44-4daf-ae34-97946f107bb0"
                                                                                                alt="facebook"
                                                                                                width="36" height="36"
                                                                                                border="0"
                                                                                    ...
                                                                                    <td width="34" align="center"><a
                                                                                            href="https://page.line.me/rio5948f?openQrModal=true"
                                                                                            target="_blank"><img
                                                                                                src="https://firebasestorage.googleapis.com/v0/b/mage8-657e0.appspot.com/o/resources%2Fimages%2Fline.png?alt=media&token=dbdfbe5c-aae6-4abb-9c38-1c74f976bf0d"
                                                                                    ...
                                                                                    <td width="33" align="center"><a
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                src="https://firebasestorage.googleapis.com/v0/b/mage8-657e0.appspot.com/o/resources%2Fimages%2Fyt.png?alt=media&token=be178e7b-3232-4116-b1b3-37ca13ad11cc"
                                                                                                alt="linkedin"
                                                                                                width="36" height="36"
                                                                                                border="0"
                                                                                                style="border-width:0; max-width:36px;height:auto; display:block; max-height:36px" /></a>
                                    ...
                                    <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%"
                                        ...
                                        <tr>
                                            <td align="left" style="padding:50px 50px 50px 50px">
                                                ...
                                                <p
                                                    style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px ">
                                                    Anda menerima email ini karena kami mendapatkan permintaan untuk
                                                    mereset password akun MAGE 8 anda. Untuk mereset password, klik
                                                    tombol berikut. <br />
                                                    <br />
                                                </p>
                                                <table border="0" align="left" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td width="250" height="60" align="center"
                                                                            ...
                                                                            <a href="{{link}}"
                                                                                style="width:250; display:block; text-decoration:none; border:0; text-align:center; font-weight:bold;font-size:18px; font-family: Arial, sans-serif; color: #ffffff"
                                                                                class="button_link">Reset Password</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
